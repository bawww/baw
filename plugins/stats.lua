...
local function run(msg, matches)
  if matches[1]:lower() == 'elektrano' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "elektrano" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/#]([Ss]tats) (group) (%d+)",
    "^([Ss]tats) (group) (%d+)",
    "^[!/#]([Ss]tats) (elektrano)",-- Put everything you like :)
    "^([Ss]tats) (bot)",-- Put everything you like :)
		"^[!/#]([Ee]lektrano)"-- Put everything you like :)
    }, 
  run = run
}
